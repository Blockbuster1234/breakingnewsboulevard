...
const posts = [  {
    ...
    excerpt: "Spain has announced it willclose its airspace to U.S. military flights linked to operations against Iran and will deny American forces the use of the jointly",
  ...
  },
{
    ...
    body: `
<p>**Whythe United States Is Watching Iran’s Kharg Island**</p><p>Kharg Island, a speck of land in the northern Persian Gulf, has become a focal point of U.S. attention because it hosts the bulk of Iran’s oil export infrastructure. The island’s terminal loads roughly 90 % of Tehran’s crude shipments, making it a linchpin of the country’s economy and a potential leverage point in Washington’s broader strategy toward Iran.</p><p>Located about 25 kilometers off the Iranian coast, Kharg Island covers less than 3 square kilometers yet handles an average of 6–7 million barrels of oil per day. The facility includes several loading berths, storage tanks, and a network of pipelines that connect to Iran’s major oil fields in the southwest. Because of its capacity and relatively shallow waters, the island allows large crude carriers to dock directly, reducing transit times and costs for Iranian exporters.</p><p>U.S. officials have long viewed Iran’s oil sector as a key source of revenue that funds the country’s military programs, including its ballistic‑missile and uranium‑enrichment activities. Since the reimposition of sanctions in 2018, Washington has sought to curb Tehran’s ability to sell crude abroad. Kharg Island’s prominence makes it a natural target for surveillance and, potentially, for measures aimed at disrupting illicit shipments.</p><p>Satellite imagery analyzed by independent researchers shows a steady increase in U.S. naval and aerial patrols near the island over the past year. The Pentagon has not confirmed any specific operations, but defense analysts say the heightened presence reflects a broader effort to monitor compliance with sanctions and to deter any attempts by Iran to evade restrictions through ship‑to‑ship transfers or deceptive routing.</p><p>Iranian authorities, meanwhile, have repeatedly warned that any interference with Kharg Island would be met with a “strong response.” Tehran has invested in upgrading the island’s defenses, deploying anti‑aircraft systems and fast‑attack craft to protect the terminal. In recent statements, Iranian oil officials have emphasized the island’s strategic importance, describing it as “the heart of our energy exports.”</p><p>The focus on Kharg Island also fits into a larger pattern of U.S. interest in chokepoints that control global energy flows. Similar attention has been paid to the Strait of Hormuz, through which roughly a fifth of the world’s oil passes, and to Saudi Arabia’s Ras Tanura terminal. By keeping tabs on Iran</p>
  },
{
    slug: "why-does-the-us-have-iran-s-kharg-island-in-its-sights",
    title: "Why does the US have Iran's Kharg Island in its sights?",
